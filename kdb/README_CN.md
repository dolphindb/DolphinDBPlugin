...
kdb+ 插件目前支持版本：[relsease200](https://github.com/dolphindb/DolphinDBPlugin/blob/release200/kdb/README_CN.md), [release130](https://github.com/dolphindb/DolphinDBPlugin/blob/release130/kdb/README_CN.md)。您当前查看的插件版本为 release130，请使用 DolphinDB 1.30.X 版本 server。若使用其它版本 server，请切换至相应插件分支。
...
为方便开发者进行自测，kdb 插件自1.30.23版本起提供自行测试的数据、脚本。以下将介绍测试文件和测试方法。
