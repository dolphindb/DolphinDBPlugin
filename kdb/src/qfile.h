...
namespace kdb {
    ...
    ConstantSP loadFileEx(DatabaseUpdater &dbUpdater, const string &tablePath, const vector<string> &symList, const string &symName, const vector<string> &colNames);
