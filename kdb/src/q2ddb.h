...
public:
    DatabaseUpdater(Heap *heap, SystemHandleSP dbHandle, ConstantSP tableName, ConstantSP partitionColumns, ConstantSP sortColumns, TableSP schema, FunctionDefSP transform);
