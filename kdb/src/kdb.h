...
public:
    ...
    ConstantSP loadTableEx(Heap *heap, ConstantSP dbHandle, ConstantSP tableName, ConstantSP partitionColumns, ConstantSP schema, long long batchSize, FunctionDefSP transform, ConstantSP sortColumns, const string &pathOrScript, const string &symPath);
