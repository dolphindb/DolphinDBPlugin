...
function(AddOpenSSL)
    ...
    if (CMAKE_SYSTEM_NAME STREQUAL "Windows")
        target_link_libraries(${PluginName} PRIVATE ws2_32 crypt32)
    endif()
endfunction()
...
function(AddArrow)
    ...
    target_link_libraries(${PluginName} PRIVATE parquet_static arrow_static)
    AddZlib()
    AddLZ4()
    AddZstd()
    find_package(Snappy REQUIRED)
    find_package(Thrift REQUIRED)
    target_link_libraries(${PluginName} PRIVATE Snappy::snappy thrift::thrift)
    if (CMAKE_SYSTEM_NAME STREQUAL "Windows")
        target_link_libraries(${PluginName} PRIVATE psapi)
    endif()
endfunction()
