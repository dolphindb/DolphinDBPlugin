...
function(CreatePlugin PluginName)
    ...
    if(UNIX OR MSYS)
        add_custom_command(TARGET ${PluginName} POST_BUILD COMMAND sed "\'s/<version>/${PluginVersion}/g\'" ${CMAKE_CURRENT_SOURCE_DIR}/${PluginName}.txt > ${PluginConfig})
    endif()
