...
ConstantSP placeholder{nullptr};
...
ConstantSP aws_set_client_config(Heap *heap, argsT &args)
{
    (void)heap;
...
ConstantSP aws_get_client_config(Heap* heap, argsT &args)
{
    (void)heap;
...
ConstantSP aws_get_object(Heap* heap, argsT &args)
{
    (void)heap;
...
ConstantSP aws_list_objects(Heap* heap, argsT &args)
{
    (void)heap;
    auto bucketArg = arg_to_string(args[1]);
...
ConstantSP aws_read_object(Heap* heap, argsT &args)
{
    (void)heap;
    auto bucketArg = arg_to_string(args[1]);
    auto keyArg = arg_to_string(args[2]);
...
ConstantSP aws_delete_object(Heap *heap, argsT &args)
{
    (void)heap;
    auto bucketArg = arg_to_string(args[1]);
...
ConstantSP aws_put_object(Heap* heap, argsT &args)
{
    (void)heap;
    auto bucketArg = arg_to_string(args[1]);
    auto keyArg = arg_to_string_vector(args[2]);
...
ConstantSP aws_list_buckets(Heap* heap, argsT &args)
{
    (void)heap;
    checkArg(args[0]->isDictionary(), __func__, ACCOUNT_SHOULD_BE_DICTIONARY);
...
ConstantSP aws_get_user_agent_features(Heap* heap, argsT &args)
{
    (void)heap;
    checkArg(args[0]->isDictionary(), __func__, ACCOUNT_SHOULD_BE_DICTIONARY);
...
ConstantSP aws_delete_bucket(Heap* heap, argsT &args)
{
    (void)heap;
    auto bucketArg = arg_to_string(args[1]);
...
ConstantSP aws_create_bucket(Heap* heap, argsT &args)
{
    (void)heap;
    auto bucketArg = arg_to_string(args[1]);
...
ConstantSP aws_head_object(Heap* heap, argsT &args)
{
    (void)heap;
    auto bucketArg = arg_to_string(args[1]);
    auto keyArg = arg_to_string(args[2]);
...
ConstantSP aws_copy_object(Heap* heap, argsT &args)
{
    (void)heap;
    auto bucketArg = arg_to_string(args[1]);
...
ConstantSP aws_load_object(Heap* heap, argsT &args)
{
