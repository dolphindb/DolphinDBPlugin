...
private:
    const int MIN_TASK_COUNT_FOR_PROBING_GROUP_SIZE = 2; // if all site's task count is less or equal than it, will group call directly and won't prob group size
