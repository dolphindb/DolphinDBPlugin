...
public:
	...
	virtual void * getRawValue(INDEX index) override {
...
public:
	...
	virtual void * getRawValue(INDEX index) override {
		...
		return source_->getRawValue(pindex_[index]);
	}
...
public:
	...
	virtual void * getRawValue(INDEX index) override {
		...
		return source_->getRawValue(index + offset_);
	}
...
public:
	...
	virtual void * getRawValue(INDEX index) override {
		...
		return subVec_.at(types_[index])->getRawValue(index_[index]);
	}
