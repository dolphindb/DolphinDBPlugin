...
ConstantSP signature(Heap* heap, const ConstantSP& a, const ConstantSP& b);
...
ConstantSP linearTimeTrend(Heap* heap, vector<ConstantSP>& args);
...
ConstantSP mmaxDrawdown(Heap* heap,vector<ConstantSP>& arguments);
...
ConstantSP fir(Heap* heap, vector<ConstantSP>& arguments);
ConstantSP iir(Heap* heap, vector<ConstantSP>& arguments);
...
ConstantSP imaxDrawdown(Heap* heap, const ConstantSP& a, const ConstantSP& b);
...
ConstantSP twavg(Heap* heap, const ConstantSP& a, const ConstantSP& b);
...
ConstantSP beta(Heap *heap, vector<ConstantSP> &arguments);
ConstantSP betaOperator(Heap *heap, const ConstantSP &a, const ConstantSP &b);
...
ConstantSP cumbeta(Heap *heap, vector<ConstantSP> &arguments);
ConstantSP cumbetaOperator(Heap* heap, const ConstantSP& a, const ConstantSP& b);
...
ConstantSP sortCol(Heap* heap,vector<ConstantSP>& arguments);
...
ConstantSP movingDynamicFuncCall(Heap* heap,vector<ConstantSP>& arguments);
...
ConstantSP rowTwavg(Heap *heap, vector<ConstantSP> &arguments);
...
ConstantSP deleteJobArtifacts(Heap* heap, vector<ConstantSP>& arguments);
ConstantSP getAllJobs(Heap* heap, vector<ConstantSP>& arguments);
