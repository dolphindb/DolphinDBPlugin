...
Exchange::Exchange(std::string &&symbol, std::string &&creator, TableSP outputTable, TableSP depthOutputTable) : AbstractStreamEngine(__func__, symbol, creator, config_.inputScheme_), symbol_(symbol), outputTable_(outputTable), depthOutputTable_(depthOutputTable) {
