...
public:
    ...
    void set(Price price, Quantity qty, uint64_t order_count, ChangeId last_change = 0);
...
inline uint64_t DepthLevel::order_count() const {
    return order_count_;
}
...
inline void DepthLevel::set(Price price, Quantity qty, uint64_t order_count, ChangeId last_change) {
    price_ = price;
    aggregate_qty_ = qty;
