...
inline const DepthLevel *
Depth::last_bid_level() const
{
  return levels_.data() + (SIZE - 1);
}

inline const DepthLevel *
Depth::last_ask_level() const
{
...
inline DepthLevel *
Depth::last_bid_level()
{
  return levels_.data() + (SIZE - 1);
}

inline DepthLevel *
Depth::last_ask_level()
{
  return levels_.data() + (SIZE * 2 - 1);
}

inline void
Depth::add_order(Price price, Quantity qty, bool is_bid)
{
...
inline void
Depth::ignore_fill_qty(Quantity qty, bool is_bid)
{
  if (is_bid) {
...
inline bool
Depth::close_order(Price price, Quantity open_qty, bool is_bid)
{
...
inline void
Depth::change_qty_order(Price price, int64_t qty_delta, bool is_bid)
{
  DepthLevel *level = find_level(price, is_bid, false);
  if (level && qty_delta) {
    if (qty_delta > 0) {
...
inline bool
Depth::needs_bid_restoration(Price &restoration_price)
{
...
inline bool
Depth::needs_ask_restoration(Price &restoration_price)
{
  // If this depth has multiple levels
  if (SIZE > 1) {
    // Restore using the price before the last level
...
inline DepthLevel *
Depth::find_level(Price price, bool is_bid, bool should_create)
{
...
inline void
Depth::erase_level(DepthLevel *level, bool is_bid)
{
