...
enum Fields {
  op, accountUid, symbol, id, quantity, condition, price, thresholdPrice, expiredTime
};

static const vector<string> fieldsNames = {
  "op", "accountUid", "symbol", "id", "quantity", "condition", "price",
  "thresholdPrice", "expiredTime",
};
